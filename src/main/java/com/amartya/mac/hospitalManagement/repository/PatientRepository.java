...
import com.amartya.mac.hospitalManagement.dto.BloodGroupCountResponseEntity;
...
public interface PatientRepository extends JpaRepository<Patient, Long> {
    ...
    @Query("select new com.amartya.mac.hospitalManagement.dto.BloodGroupCountResponseEntity(p.bloodGroup," +
